...
export const SchedulerAPI = {
  ...
  deleteSprintTaskLogs: (sprintId) => api.delete('/task_logs/destroy_for_sprint.json', { params: { sprint_id: sprintId } }),
...
export const fetchDepartment = (id) => api.get(`/departments/${id}.json`);
