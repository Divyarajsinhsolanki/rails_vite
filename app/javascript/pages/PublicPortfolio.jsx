  ...
  return (
    <div className="min-h-screen overflow-hidden bg-[#07111f] text-white">
      ...
      <main id="top" className="relative">
        <section className="mx-auto grid min-h-[86vh] max-w-7xl items-center gap-12 px-5 py-20 sm:px-8 lg:grid-cols-[1.25fr_0.75fr]">
          <div>
            ...
            <h1 className="mt-7 max-w-5xl text-5xl font-semibold leading-[0.96] tracking-[-0.065em] sm:text-7xl lg:text-[5.6rem]">
              I build full-stack products that solve real workflow problems.
            </h1>
            <p className="mt-7 max-w-3xl text-lg leading-8 text-slate-300 sm:text-xl">{profile.summary}</p>
          ...
          <div className="relative mx-auto w-full max-w-md">
            ...
            <div className="relative rounded-[42px] border border-white/10 bg-slate-900/90 p-8 shadow-2xl">
              {profile.avatar_url ? (
                <img src={profile.avatar_url} alt={`${profile.full_name} portrait`} className="aspect-square w-full rounded-[30px] object-cover" />
              ) : (
                <div className="flex aspect-square items-center justify-center rounded-[30px] bg-gradient-to-br from-slate-800 to-slate-950 text-8xl font-semibold text-cyan-300">{initials}</div>
              )}
        ...
        <section id="about" className="border-y border-white/10 bg-white/[0.03]">
          <div className="mx-auto grid max-w-7xl gap-10 px-5 py-20 sm:px-8 lg:grid-cols-[0.75fr_1.25fr]">
            <div>
              <p className="text-xs font-bold uppercase tracking-[0.3em] text-cyan-300">About</p>
              <h2 className="mt-4 text-4xl font-semibold tracking-[-0.05em]">Product thinking with full-stack execution.</h2>
            </div>
            <div>
              <p className="text-lg leading-8 text-slate-300">{profile.headline}. My work covers data modeling, API design, authorization, complex UI state, realtime behavior, background processing, integrations, and deployment.</p>
        ...
        <section id="case-study" className="mx-auto max-w-7xl px-5 py-20 sm:px-8">
          <div className="grid gap-10 lg:grid-cols-[0.8fr_1.2fr]">
            <div>
              <p className="text-xs font-bold uppercase tracking-[0.3em] text-cyan-300">Flagship Case Study</p>
              <h2 className="mt-4 text-5xl font-semibold tracking-[-0.055em]">{project?.title || "Nexus Hub"}</h2>
              <p className="mt-5 text-xl leading-8 text-slate-300">{project?.tagline || "One connected workspace for product delivery and personal productivity."}</p>
            ...
            <div className="rounded-[34px] border border-white/10 bg-gradient-to-br from-white/10 to-white/[0.03] p-7 sm:p-9">
              <p className="text-lg leading-8 text-slate-200">{project?.summary || "Nexus Hub brings planning, delivery, communication, knowledge, and document tools into one Rails and React product."}</p>
        ...
        <section id="features" className="border-y border-white/10 bg-white/[0.03]">
          <div className="mx-auto max-w-7xl px-5 py-20 sm:px-8">
            ...
            <h2 className="mt-4 max-w-3xl text-4xl font-semibold tracking-[-0.05em] sm:text-5xl">A large product, organized for a fast technical review.</h2>
        ...
        <section id="architecture" className="mx-auto max-w-7xl px-5 py-20 sm:px-8">
          <div className="grid gap-10 lg:grid-cols-2">
            <div>
              ...
              <h2 className="mt-4 text-4xl font-semibold tracking-[-0.05em] sm:text-5xl">Built across the complete application stack.</h2>
            </div>
        ...
        <section id="contact" className="border-t border-white/10 bg-slate-950">
          <div className="mx-auto grid max-w-7xl gap-10 px-5 py-20 sm:px-8 lg:grid-cols-[0.8fr_1.2fr]">
            <div>
              ...
              <h2 className="mt-4 text-4xl font-semibold tracking-[-0.05em]">Let’s discuss the role and the problems you need solved.</h2>
